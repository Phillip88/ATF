...
codecola.plug.fontFamily.prototype.render = function(CODECOLA){
    ...
    CODECOLA.renderPlug(
        ...
        '   <cctitle><label for="codeCola-fontFamily">' + CODECOLA.chromeGetMSG("properties_lst") + '</label><cci class="codeCola-arrow"></cci><cci class="codeCola-eye" title="' + CODECOLA.chromeGetMSG("opt_hide") + '" data="fontFamily"></cci></cctitle>' +
        '   <div class="codeCola-editorWrap">' +
		'   <ccfieldset id="codeCola-boxShadowWrap">' +
		'	    <ol>' +
		'			<li><label>Element&nbsp;&nbsp;type:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
		'				<label id="elementType"></label></li>' +
		'			<li><label>Element&nbsp;&nbsp;ID:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
		'				<input type="text" id="elementId" value="<Non Id>" disabled="disabled"/></li>' +
		'			<li><label>Element&nbsp;&nbsp;value:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
		'				<input type="text" id="elementValue"/>' +
		'				<button id="phatbeo" type="button" class="codeCola-clear-value">Clear</button></li>' +
		'		</ol>' +
		'	</ccfieldset>' +
        '   </div>' +
        '</li>'
